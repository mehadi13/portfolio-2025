...
import { ArrowRight, Briefcase, Code, Mail, Github, Linkedin, Download, Award, FileText, Wrench, MapPin, GraduationCap, MessageSquare, Phone, MessageCircle } from "lucide-react"
        ...
        <section className="min-h-[90vh] flex flex-col items-center justify-center py-20 text-center">
          <div className="mb-8 animate-fade-in">
            <div className="relative w-48 h-48 md:w-56 md:h-56 mx-auto mb-6 group">
              ...
              <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-primary/20 shadow-2xl transition-smooth hover:shadow-2xl hover:scale-120 ring-4 ring-primary/10">
                <Image
          ...
          >
            <Button
              asChild
              size="lg"
              className="group transition-smooth hover:bg-primary/90"
            >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="group glass-card dark:glass-card-dark transition-smooth hover:!bg-primary hover:!text-primary-foreground hover:border-primary"
            >
              <a
          ...
          >
            {contactInfo.socialLinks.linkedin && (
              <Button
                ...
                size="icon"
                asChild
                className="glass-card dark:glass-card-dark hover:scale-110"
              >
                <a
                        ...
                        <div className="flex flex-wrap gap-2">
                          {skill.items.map((item) => (
                            <Badge
                              key={item}
                              variant="outline"
                              className="transition-smooth hover:bg-primary hover:text-primary-foreground hover:border-primary hover:scale-105 cursor-pointer"
                            >
                              {item}
                            </Badge>
                          ))}
              ...
              >
                <div className="glass-card dark:glass-card-dark p-8 rounded-2xl">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                    ...
                    <Badge className="mt-4 md:mt-0 w-fit">
                ...
                <div className="flex gap-4">
                  {contactInfo.socialLinks.linkedin && (
                    <Button
                      ...
                      size="icon"
                      asChild
                      className="glass-card dark:glass-card-dark hover:scale-110 transition-smooth hover:bg-primary hover:text-primary-foreground hover:border-primary"
                    >
                      <a
                        href={contactInfo.socialLinks.linkedin}
                        target="_blank"
